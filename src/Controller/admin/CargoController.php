...
{
    #[Route('/', name: 'app_admin_cargo_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_admin_cargo_new', methods: ['GET', 'POST'])]
    public function new(Request $request, CargoRepository $cargoRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_cargo_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_admin_cargo_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_admin_cargo_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_admin_cargo_delete', methods: ['POST'])]
